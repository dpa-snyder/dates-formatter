...
* **Asset:** `date-formatter-v0.2.10-windows-amd64.exe`
...
* **Asset:** `date-formatter-v0.2.10-macos-arm64.zip`
...
* **Assets:** `date-formatter-v0.2.10-linux-amd64.deb`, `date-formatter-v0.2.10-linux-x86_64.rpm`, and `date-formatter-v0.2.10-linux-amd64.tar.gz`
